...
/**
 * This class is AzureSpatialAnchorsManager which is used to:
 * 1. configure credentials
 * 2. manage locating from azure spatial anchors
 *
 ...
 */
class AzureSpatialAnchorsManager extends AppCompatActivity {
    // Set this string to the account ID provided for the Azure Spatial Anchors account resource.
    public static final String SpatialAnchorsAccountId = "c8f898a6-6aa9-4c6a-ae25-d83e205059f5";
    // Set this string to the account key provided for the Azure Spatial Anchors account resource.
    public static final String SpatialAnchorsAccountKey = "6e5RV4lhmmH2kNlhTZato5z3ACJ525d7R7aCVWuwcjk=";
    // Set this string to the account domain provided for the Azure Spatial Anchors account resource.
    public static final String SpatialAnchorsAccountDomain = "westeurope.mixedreality.azure.com";
